...
def argparser():
    ...
    parser.add_argument(
        "--root_path",
        type=str,
        default="data/raw_data_wNE/",
        help="root path of the raw file",
    )
    parser.add_argument(
        "--data_path",
        type=str,
        default="data/dst_data_wNE/epoch/",
    ...
    parser.add_argument(
        "--pad", action="store_true", help="if pad the seq", default=False
    )
    parser.add_argument(
        "--subtract_last",
        type=int,
    ...
    parser.add_argument(
        "--seq_layers", type=int, default=2, help="num of encoder layers"
    )
    ...
    parser.add_argument(
        "--scale", type=float, default=0.0, help="scale for distillation loss"
    )
    # cycle LR
    parser.add_argument(
    ...
    # Visualizations
    parser.add_argument(
        "--visualize_mode", nargs="*", default=[""], help="visualize mode"
    )
    parser.add_argument(
        "--visualizations",
        type=str,
