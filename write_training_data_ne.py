...
def prepare_data(mat_file, seq_len=128, augment=False, upsampling_scale=10):
...
def prepare_data_ne(mat_file, seq_len=128, augment=False, upsampling_scale=10):
    mat = loadmat(mat_file)
    eeg, emg, ne, sleep_scores = reshape_sleep_data_ne(mat)
    sleep_scores_len = len(sleep_scores)
    ne_len = len(ne)
