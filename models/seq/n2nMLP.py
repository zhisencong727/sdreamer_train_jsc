...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.eeg_ep_encoder = MLP_EpochEncoder(
            seq_len, inner_dim, depth=e_layers, dropout=dropout, activation=activation
        )

        self.emg_ep_encoder = MLP_EpochEncoder(
            seq_len, inner_dim, depth=e_layers, dropout=dropout, activation=activation
        )
    ...
    def forward(self, x, label):
        ...
        out_dict = {"out": out, "seq_attn": seq_attn, "emb": emb, "label": label}
        return out_dict
