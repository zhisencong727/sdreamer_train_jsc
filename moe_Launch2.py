...
def argparser():
    ...
    parser.add_argument(
        "--isNE",
        action="store_false",
        help="whether to include the NE data",
        default=True,
    )
    ...
    parser.add_argument(
        "--batch_size", type=int, default=512, help="batch size of train input data"
    )
    parser.add_argument(
    ...
    # For weighted loss
    parser.add_argument(
        "--weight", type=list, default=[], help="Weights for cross entropy loss"
    )

    # Visualizations
    parser.add_argument(
        "--visualize_mode", nargs="*", default=["att"], help="visualize mode"
    )
    parser.add_argument(
        "--visualizations",
        type=str,
